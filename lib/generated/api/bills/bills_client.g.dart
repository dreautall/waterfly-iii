...
class _BillsClient implements BillsClient {
  ...
  Future<SubscriptionArray> listSubscriptions({
    ...
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<SubscriptionArray>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = SubscriptionArray.fromJson(_result.data!);
    return value;
  }
  ...
  Future<SubscriptionSingle> getSubscription({
    ...
    const Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<SubscriptionSingle>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = SubscriptionSingle.fromJson(_result.data!);
    return value;
  }
