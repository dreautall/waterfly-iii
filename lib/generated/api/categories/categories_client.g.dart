...
class _CategoriesClient implements CategoriesClient {
  ...
  Future<CategoryArray> listCategory({
    ...
    const Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<CategoryArray>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = CategoryArray.fromJson(_result.data!);
    return value;
  }
  ...
  Future<CategorySingle> storeCategory({
    ...
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<CategorySingle>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    ...
    final value = CategorySingle.fromJson(_result.data!);
    return value;
  }
