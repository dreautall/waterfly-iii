...
class _LinksClient implements LinksClient {
  ...
  Future<LinkTypeArray> listLinkType({
    ...
    const Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<LinkTypeArray>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = LinkTypeArray.fromJson(_result.data!);
    return value;
  }
  ...
  Future<LinkTypeSingle> storeLinkType({
    ...
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<LinkTypeSingle>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    ...
    final value = LinkTypeSingle.fromJson(_result.data!);
    return value;
  }
  ...
  Future<TransactionLinkArray> listTransactionLink({
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<TransactionLinkArray>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = TransactionLinkArray.fromJson(_result.data!);
    return value;
  }
  ...
  Future<TransactionLinkSingle> storeTransactionLink({
    ...
    _data.addAll(body.toJson());
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<TransactionLinkSingle>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
      contentType: 'application/x-www-form-urlencoded',
    ...
    final value = TransactionLinkSingle.fromJson(_result.data!);
    return value;
  }
