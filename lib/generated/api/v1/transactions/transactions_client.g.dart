...
class _TransactionsClient implements TransactionsClient {
  ...
  Future<TransactionSingle> getTransactionByJournal({
    ...
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<TransactionSingle>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = TransactionSingle.fromJson(_result.data!);
    return value;
  }
  ...
  Future<PiggyBankEventArray> listEventByTransaction({
    ...
    const Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<PiggyBankEventArray>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = PiggyBankEventArray.fromJson(_result.data!);
    return value;
  }
