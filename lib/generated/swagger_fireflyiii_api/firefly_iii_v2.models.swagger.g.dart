...
Map<String, dynamic> _$TransactionSumToJson(
  TransactionSum instance,
) => <String, dynamic>{
  ...
  if (instance.nativeCurrencyId case final value?) 'native_currency_id': value,
...
BudgetLimitReadV2 _$BudgetLimitReadV2FromJson(Map<String, dynamic> json) =>
    BudgetLimitReadV2(
      type: json['type'] as String,
      id: json['id'] as String,
      attributes: BudgetLimitV2.fromJson(
        json['attributes'] as Map<String, dynamic>,
      ),
    );
...
ChartDataPointV2 _$ChartDataPointV2FromJson(Map<String, dynamic> json) =>
    ChartDataPointV2(key: json['key'] as String?);
...
ChartDataSetV2 _$ChartDataSetV2FromJson(
  Map<String, dynamic> json,
) => ChartDataSetV2(
...
Map<String, dynamic> _$ChartDataSetV2ToJson(
  ChartDataSetV2 instance,
) => <String, dynamic>{
  ...
  if (chartV2PeriodPropertyNullableToJson(instance.period) case final value?)
    'period': value,
...
CurrencyV2Read _$CurrencyV2ReadFromJson(Map<String, dynamic> json) =>
    CurrencyV2Read(
      type: json['type'] as String,
      id: json['id'] as String,
      attributes: CurrencyV2.fromJson(
        json['attributes'] as Map<String, dynamic>,
      ),
    );
...
Map<String, dynamic> _$PiggyBankV2ToJson(
  PiggyBankV2 instance,
) => <String, dynamic>{
  if (instance.createdAt?.toIso8601String() case final value?)
    'created_at': value,
  if (instance.updatedAt?.toIso8601String() case final value?)
  ...
  if (instance.nativeLeftToSave case final value?) 'native_left_to_save': value,
...
PiggyBankV2Read _$PiggyBankV2ReadFromJson(Map<String, dynamic> json) =>
    PiggyBankV2Read(
      type: json['type'] as String,
      id: json['id'] as String,
      attributes: PiggyBankV2.fromJson(
        json['attributes'] as Map<String, dynamic>,
      ),
...
Map<String, dynamic> _$SubscriptionToJson(
  ...
  if (instance.nativeAmountMin case final value?) 'native_amount_min': value,
  if (instance.nativeAmountMax case final value?) 'native_amount_max': value,
  if (instance.currencyId case final value?) 'currency_id': value,
  if (instance.currencyCode case final value?) 'currency_code': value,
  if (instance.currencySymbol case final value?) 'currency_symbol': value,
  if (instance.currencyDecimalPlaces case final value?)
  ...
  if (subscriptionRepeatPropertyToJson(instance.repeatFreq) case final value?)
    'repeat_freq': value,
...
SubscriptionRead _$SubscriptionReadFromJson(Map<String, dynamic> json) =>
    SubscriptionRead(
      type: json['type'] as String,
      id: json['id'] as String,
      attributes: Subscription.fromJson(
        json['attributes'] as Map<String, dynamic>,
      ),
    );
...
TransactionV2Read _$TransactionV2ReadFromJson(Map<String, dynamic> json) =>
    TransactionV2Read(
      type: json['type'] as String,
      id: json['id'] as String,
      attributes: TransactionV2.fromJson(
        json['attributes'] as Map<String, dynamic>,
      ),
      links: ObjectLinkV2.fromJson(json['links'] as Map<String, dynamic>),
    );
...
Map<String, dynamic> _$TransactionV2SplitToJson(
  TransactionV2Split instance,
) => <String, dynamic>{
  if (instance.user case final value?) 'user': value,
  if (instance.userGroup case final value?) 'user_group': value,
  if (instance.transactionJournalId case final value?)
...
Map<String, dynamic> _$NetWorthArrayToJson(
  NetWorthArray instance,
) => <String, dynamic>{
  if (instance.currencyCode?.toJson() case final value?) 'currency_code': value,
};
...
Map<String, dynamic> _$NetWorthItemToJson(
  NetWorthItem instance,
) => <String, dynamic>{
